			...
			<form class="episode" action="" method="POST">
				...
				<header class="text-center">
					<div class="badge badge-primary mw-100">
						#
						<input class="ghost text-white mw-100" type="text" name="episode-number" id="input-episode-number" value="<?= $episode->number() ?>" pattern="[0-9]{,99999}" placeholder="épisode" size="1" required>
						<span class="mr-1">-</span>
						<input class="ghost text-white mw-100" type="text" name="episode-part" id="input-episode-part" value="<?= $episode->part() ?>" pattern="[0-9]{,99999}" placeholder="partie" size="1">
					</div>
					...
					<div class="input-group justify-content-center mb-3">
						...
						<input class="form-control flex-g-0" type="text" name="episode-slug" id="input-episode-slug" value="<?= $episode->slug() ?>" pattern="[a-z0-9-]{,255}" placeholder="Laissé vide, il sera généré automatiquement." aria-describedby="basic-addon-slug">
					</div>
				</header>
