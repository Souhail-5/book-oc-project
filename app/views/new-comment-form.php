<form action="" method="POST">
	...
	<label for="comment-name">Nom</label>
		<input type="text" class="form-control" id="comment-name" name="comment-name" aria-describedby="name-help" placeholder="Votre nom" pattern="[a-zA-Z ]{5,50}" required>
	...
	<div class="form-group">
		...
		<input type="email" class="form-control" id="comment-email" name="comment-email" aria-describedby="email-help" placeholder="Votre e-mail" required>
	...
	<label for="comment-textarea">Votre commentaire</label>
		<textarea class="form-control" id="comment-textarea" name="comment-text" aria-describedby="text-help" rows="10" required minlength="140" maxlength="1400"></textarea>
